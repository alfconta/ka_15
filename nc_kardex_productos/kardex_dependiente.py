...
where pt.categ_id = %s
    """
            ...
            for prod in g:
                ...
                worksheet.write(4+ conteo, 12, _('Invoice Supplier'), column_heading_style)
                worksheet.write(4+ conteo, 13, _('Custumer/Supplier'), column_heading_style)
    ...
    """
        ...
        worksheet.write(4, 12, _('Invoice Supplier'), column_heading_style)
        worksheet.write(4, 13, _('Customer/Supplier'), column_heading_style)
...
class kardex_productos_inventario_detalle2(models.TransientModel):
    ...
    fact_supplier = fields.Char(string='fact_supp')
